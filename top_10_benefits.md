...
9. **Add optional AI proposals** — Use Tundra's built-in capped OpenRouter key or an optional personal override to suggest top-level values, then inspect results after the run.
